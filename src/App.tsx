...
class App extends React.Component { 
  ...
  render() {
    const BMICalcProps = { name: this.state.name, gender: this.state.gender, height: this.state.height, weight: this.state.weight, currField:this.state.currField } // look into why this works 
    return (
      <div className="App">
